...
import workerHours from "./components/showWorker/workerHours";
...
import workerHour from "./components/workerHour";
    ...
    <Router>
      <Layout>
        <div>
          ...
          <AuthRoute path="/workerHour" component={workerHour} />
          ...
          <AuthRoute path="/workerhours" component={workerHours} />
