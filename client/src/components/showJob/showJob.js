  ...
  const requestSearch = (searchedVal) => {
    ...
    if (searchedVal === "") {
      ...
      const filteredRows = rows.filter((job) => {
        return ( 
             job.name.toLowerCase().includes(searchedVal.toLowerCase()) 
          || job.discription.toLowerCase().includes(searchedVal.toLowerCase())
          || job.position.toLowerCase().includes(searchedVal.toLowerCase()) 
          || job.payPerHour.toLowerCase().includes(searchedVal.toLowerCase()) 
